Vue.component('left-menu', {
          ...
          <div class="nav_sonsArrow " :class="{\'active\': isLeft}">\
            <div class="nav_sons">\
              ...
              <div v-if="nav_status=== 1" class="nav_son_absolute">\
                ...
                <div class="nav_son" :class="{\'active\':cc==18}" v-if="get_index(7)!=-1">\
                  <a href="./console8.html">\
                    <img v-if="cc!=18" src="img/icons8-minus_1year_filled.png" alt="" />\
                    <img v-if="cc==18" src="img/icons8-minus_1year_filledActive.png" alt="" />\
                    <span>返回區域比率</span>\
                  </a>\
                </div>\
              ...
              <div v-else-if="nav_status=== 2" class="nav_son_absolute">\
                <div class="nav_son" :class="{\'active\':cc==21}" v-if="get_index(9)!=-1">\
                  <a href="./reservation_order.html?page=1&pmod=1&status=&key=">\
                ...
                <div class="nav_son" :class="{\'active\':cc==22}" v-if="get_index(10)!=-1">\
                  <a href="./reservation_order.html?page=1&pmod=2&status=&key=">\
                ...
                <div class="nav_son" :class="{\'active\':cc==23}" v-if="get_index(11)!=-1">\
                  <a href="./reservation_order.html?page=1&pmod=3&status=&key=">\
                ...
                <div class="nav_son" :class="{\'active\':cc==24}" v-if="get_index(12)!=-1">\
                  <a href="./reservation_order.html?page=1&pmod=4&status=&key=">\
                ...
                <div class="nav_son" :class="{\'active\':cc==25}" v-if="get_index(13)!=-1">\
                  <a href="./reservation_order.html?page=1&pmod=5&status=&key=">\
              ...
              <div v-else-if="nav_status=== 4" class="nav_son_absolute">\
                ...
                <!--<div class="nav_son" :class="{\'active\':cc==42}" v-if="get_index(19)!=-1">\
                  <a href="./personal.html?page=1&key=&isDescending=true&pMode=2">\
                ...
                <div class="nav_son" :class="{\'active\':cc==43}" v-if="get_index(20)!=-1">\
                  <a href="./personal.html?page=1&key=&isDescending=true&pMode=3">\
                ...
                <div class="nav_son" :class="{\'active\':cc==44}" v-if="get_index(21)!=-1">\
                  <a href="./personal.html?page=1&key=&isDescending=true&pMode=4">\
                ...
                <div class="nav_son" :class="{\'active\':cc==45}" v-if="get_index(22)!=-1">\
                  <a href="./personal.html?page=1&key=&isDescending=true&pMode=5">\
              ...
              <div v-else-if="nav_status=== 5" class="nav_son_absolute">\
                <div class="nav_son" :class="{\'active\':cc==51}" v-if="get_index(24)!=-1">\
                  <a href="./driverVehicle.html?page=1&carType=0&Status=&key=&isDescending=true&orderby=">\
                    <img v-if="cc!=51" src="img/icons8-car_filled.png" alt="" />\
                    <img v-if="cc==51" src="img/icons8-time_card_filledACTIVE.png" alt="" />\
                    <span>車輛資料</span>\
                  </a>\
                </div>\
                <div class="nav_son" :class="{\'active\':cc==52}" v-if="get_index(25)!=-1">\
                ...
                <div class="nav_son" :class="{\'active\':cc==53}" v-if="get_index(26)!=-1">\
                  <a href="./driverVehicle_maintenance.html?id=&page=1">\
                ...
                <div class="nav_son" :class="{\'active\':cc==54}" v-if="get_index(27)!=-1">\
                  <a href="./driverVehicle_driver.html?page=1&key=&orderby=&isDescending=true">\
                    <img v-if="cc!=54" src="img/icons8-driver_filled.png" alt="" />\
                    <img v-if="cc==54" src="img/icons8-driver_filledACTIVE.png" alt="" />\
                    <span>駕駛資料</span>\
                  </a>\
                </div>\
                <div class="nav_son" :class="{\'active\':cc==55}" v-if="get_index(28)!=-1">\
  ...
  mounted:async function (){
    ...
    await this.put_header(obj.token)
    await axios.get("https://api.donkeymove.com/api/Permission/GetMenuIds?uid="+obj.uid.Id)
	.then(async res => {
	  if(res.data.msg=="獲取成功") {
	    this.menu=res.data.response
	    console.log(this.menu);
	  }
	  else {
		await this.RefreshToken()
		await this.put_header()
	  }
	})
